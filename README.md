...
|:--------------------------------------------------------:|:-------:|:------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------:|
|  <img src="https://github.com/SeoYunnn.png" width="60">  | **이서윤** |      팀장 / BE       | • **위장 정책 설계**: 관심종목 위장 파일명 치환 및 기호 필터링 구축<br>• **시뮬레이션 엔진**: 물타기/추가매수 7대 자산 지표 연산 및 로그 적재<br>• **선행지표**: 상태 표시줄 위장용 5대 매크로 지수 조회 컴파일 완료 및 AI 뉴스 서버 연동 <br>• **핵심 기능**: SMTP 임시 비밀번호 발송 가드 및 정렬 가능한 관심종목 API 구현 |   [@SeoYunnn](https://github.com/SeoYunnn)   |
| <img src="https://github.com/leekyuhyun.png" width="60"> | **이규현** | FE 팀장 / Full Stack | • **FE 아키텍처**: FE 개발 환경 초기 구축 및 코드 컨벤션 수립<br>• **AI 뉴스 파이프라인**: 뉴스 스크랩 서버 구축 및 AI 요약 레이어 연동<br>• **커뮤니티 UI**: Socket.IO 기반 실시간 글로벌/종목별 위장 채팅 화면 개발                                                              | [@leekyuhyun](https://github.com/leekyuhyun) |
| <img src="https://github.com/aeri123443.png" width="60"> | **정애리** |     Full Stack     | • **시세 동기화**: KIS Open API 연동 및 실시간 시세 폴링 파이프라인 구축<br>• **데이터 캐싱**: Redis 기반 토큰 및 실시간 시세 데이터 고속 캐싱 적용<br>• **DevOps & API**: GitHub Actions CI 자동화 구축 및 마스터 종목 조회 API 구현                                        | [@aeri123443](https://github.com/aeri123443) |
| <img src="https://github.com/leejh2114.png" width="60">  | **이정현** |     Full Stack     | • **서버 배포**: AWS EC2, Docker Compose, Nginx 기반 HTTPS/WSS 구축<br>• **채팅 엔진**: Socket.IO 실시간 채팅방, 금칙어 필터링 및 블라인드 처리 구현<br>• **자산 API**: JWT 회원/비회원 세션 가드, 다중 캔들 차트, 보유 자산 CRUD 구현                                  |  [@leejh2114](https://github.com/leejh2114)  |
|  <img src="https://github.com/yomiyoni.png" width="60">  | **이연희** |         FE         | • **디자인 시스템**: 테일윈드 기반 공통 컴포넌트 및 IDE 테마 스타일 구축<br>• **탭 뷰 전환**: VS Code 탭 스타일의 도메인별 화면(뉴스·시세·차트) 스위칭 구현<br>• **회원 및 외부 연동**: 야후 파이낸스 API 연동 및 인증(로그인·회원가입) 화면 구현                                                |   [@yomiyoni](https://github.com/yomiyoni)   |
|  <img src="https://github.com/TeemoGB.png" width="60">   | **정영호** |         FE         | • **시뮬레이터 UI**: 복합 매수 연산 처리를 위한 물타기 대시보드 구현<br>• **보안 스위치**: 긴급 화면 전환을 위한 패닉 핫키(Panic Key) 이벤트 바인딩<br>• **터미널 알림**: 관심 종목 급등락 감지 시 실시간 터미널 형태 경고 알림 연동                                                          |    [@TeemoGB](https://github.com/TeemoGB)    |
...
<p align="center">
  <img src="img/img_1.png" alt="VS Code 가상 파일 탐색기 위장 UI" width="600"/>
  <br>
  <em>[사이드바] 주식 자산을 개발 파일 트리 구조로 마스킹 처리한 탐색기 UI</em>
</p>

<p align="center">
  <img src="img/img_2.png" alt="에디터 탭 내부 주가 데이터 소스코드 시각화 UI" width="600"/>
  <br>
...
<p align="center">
  <img src="img/img_3.png" alt="물타기 시뮬레이터 UI" width="600"/>
  <br>
...
<p align="center">
  <img src="img/img_4.png" alt="하단 상태 표시줄 실시간 지수 스트림 UI" width="600"/>
  <br>
...
<p align="center">
  <img src="img/img_5.png" alt="하단 터미널 위장 실시간 채팅 UI" width="600"/>
  <br>
...
<p align="center">
  <img src="img/img_6.png" alt="소스 코드 주석 위장 AI 뉴스 UI" width="600"/>
  <br>
